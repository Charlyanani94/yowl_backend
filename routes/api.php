...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/images/upload-url', [ImageController::class, 'uploadImageFromUrl']);
});
...
Route::middleware(['auth:sanctum', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::patch('/reports/{report}/process', [ReportController::class, 'processReport']);
    
    // Routes admin pour les catégories
    Route::get('/categories', [CategoryController::class, 'adminIndex']);
    Route::get('/categories/stats', [CategoryController::class, 'adminStats']);
    ...
    Route::patch('/categories/{category}', [CategoryController::class, 'adminUpdate']);
    Route::delete('/categories/{category}', [CategoryController::class, 'adminDestroy']);
