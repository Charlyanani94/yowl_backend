...
class ReactionController extends Controller
{
    ...
    /**
 * @OA\Get(
 *     path="/api/posts/{post}/reactions",
 *     summary="Obtenir les statistiques de réactions d'un post",
 *     tags={"Reactions"},
 *     security={{"sanctum":{}}},
 *     @OA\Parameter(
 *         name="post",
 ...
 *     @OA\Response(
 *         response=200,
 *         description="Réaction ajoutée ou modifiée avec succès",
 *         @OA\JsonContent(
 *             @OA\Property(property="reaction", type="object", nullable=true),
 *             @OA\Property(property="likes_count", type="integer"),
 *             @OA\Property(property="dislikes_count", type="integer")
 *         )
 *     )
 ...
 * @OA\Delete(
 *     path="/api/posts/{post}/reactions",
 *     summary="Supprimer la réaction de l'utilisateur sur un post",
 *     tags={"Reactions"},
 *     security={{"sanctum":{}}},
 *     @OA\Parameter(
 *         name="post",
 ...
 */
    ...
    /**
 * @OA\Get(
 *     path="/api/posts/{post}/reactions/user/me",
 *     summary="Obtenir la réaction de l'utilisateur connecté sur un post",
 *     tags={"Reactions"},
 *     security={{"sanctum":{}}},
 *     @OA\Parameter(
 *         name="post",
 ...
 *     @OA\Response(
 *         response=200,
 *         description="Réaction trouvée ou aucune réaction",
 *         @OA\JsonContent(
 *             @OA\Property(property="reaction", type="object", nullable=true)
 *         )
 *     )
